...
- Module path: `github.com/artur-oliveira/ctech-wallet/api`. Go `1.26`.
...
- [ ] **Step 1: Copy boilerplate verbatim, change module path.** Copy these files from `/home/artur/Documents/Projects/Ctech/ctech-dfe/api/` preserving content, then `sed`-replace the import prefix `github.com/artur-oliveira/ctech-dfe/api` → `github.com/artur-oliveira/ctech-wallet/api`:
...
import "github.com/gofiber/fiber/v3"
import "github.com/artur-oliveira/ctech-wallet/api/internal/problem"
