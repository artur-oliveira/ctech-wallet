  ...
  return (
    ...
    >
      <DialogContent initialFocus={copyRef}>
        ...
        {expired ? (
          <p role="status"
             className="mt-5 rounded-lg border border-destructive/30 bg-destructive/10 p-3 text-center text-sm text-destructive">
            {t('pix.expired')}
          </p>
        ) : (
          <>
            ...
            <p
              className="mt-5 break-all rounded-lg bg-muted p-3 font-mono text-xs leading-relaxed text-muted-foreground">
