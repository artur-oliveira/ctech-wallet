        ...
        <LegalPage title="Termo de Jogo Responsável — CTech Wallet" updatedAt={UPDATED_AT}>
            ...
            <LegalSection heading="1. A carteira de jogo">
                <p>
                    ...
                    carteira de jogo <strong>continua sendo dinheiro real e seu</strong>: você pode devolvê-lo ao saldo
                    real
                ...
                <p>
                    ...
                    assinaturas e serviços. É a <strong>única</strong> porta pela qual dinheiro real chega aos jogos:
                    não é
            ...
            <LegalSection heading="2. Limites pessoais">
                <p>
                    Você define <strong>quanto pode transferir do saldo real para a carteira de jogo</strong> por dia,
                    por
                    semana e por mês. O limite diário não pode ser maior que o semanal, e o semanal não pode ser maior
                    que o
                    mensal.
                </p>
                <p>
                    O limite conta o <strong>total enviado</strong> no período. Devolver dinheiro da carteira de jogo
                    para o
                    saldo real <strong>não</strong> libera limite de volta — caso contrário o limite não limitaria nada.
                </p>
                <p className="font-medium text-foreground">
                    Reduzir um limite vale imediatamente. Aumentar um limite só passa a valer depois de um prazo de
                    espera:
            ...
            <LegalSection heading="3. Créditos sandbox">
                <p>
                    Créditos sandbox são comprados com o saldo da <strong>carteira de jogo</strong> e servem para
                    participar
                    de partidas em jogos de habilidade integrados.
                </p>
                <p className="font-medium text-foreground">
                    Créditos sandbox não têm valor em dinheiro, não podem ser sacados e não podem ser convertidos de
                    volta em
            ...
            <LegalSection heading="4. Quem pode ativar">
                <p>
                    ...
                    ativação é opcional: se você usa a carteira apenas para assinaturas e serviços, não precisa dela e
                    nada
            ...
            <LegalSection heading="5. Jogue com responsabilidade">
                <p>
                    Jogos com dinheiro podem causar dependência. Aposte apenas o que você pode perder, e use os limites
                    — eles
                    existem para isso.
                </p>
                <p>
